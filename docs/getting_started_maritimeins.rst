...
1. Install ANELLO's `AMarinerControl <https://github.com/Anello-Photonics/amarinercontrol/releases/download/v1.1.1/AMarinerControl-Setup.exe>`_ on your Windows computer. For macOS and Linux support contact support@anellophotonics.com.
