...
ANELLO recommends using the latest firmware (FW) for best results. The latest FW release is a1.0.1.
...
3. Find location of FW image and right click -> "copy as path"

.. image:: media/copy-path.png
   :width: 80%
   :align: center

4. Open Device Manager and find which serial port is the serial connection.
5. In terminal:
...
6. After it completes, you will see "Rebooting. Elapsed Time x.x" - this means the FW upgrade was successful.
...
Also make sure your installation of `AMarinerControl <https://github.com/Anello-Photonics/amarinercontrol/releases/v1.2.1/>`__ is v1.2.1 or higher. 
