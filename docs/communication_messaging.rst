...
3.1.5. XDR: Transducer Measurements (Heading, Roll & Pitch)
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

**Message Format**::

    $--XDR,A,x.x,D,HDG,A,x.x,D,ROLL,A,x.x,D,PITCH*hh

+--------+-------------+--------------------------------------------------------------------------+
| Index  | Part        | Description                                                              |
+========+=============+==========================================================================+
| 1      | A           | Transducer type #1 (angular displacement)                                |
+--------+-------------+--------------------------------------------------------------------------+
| 2      | x.x         | Heading measurement, degrees between 0.0 and 360.0                       |
+--------+-------------+--------------------------------------------------------------------------+
| 3      | D           | Heading units (degrees)                                                  |
+--------+-------------+--------------------------------------------------------------------------+
| 4      | HDG         | Transducer #1 ID (heading)                                               |
+--------+-------------+--------------------------------------------------------------------------+
| 5      | A           | Transducer type #2 (angular displacement)                                |
+--------+-------------+--------------------------------------------------------------------------+
| 6      | x.x         | Roll measurement, degrees between -90.0 and 90.0                         |
+--------+-------------+--------------------------------------------------------------------------+
| 7      | D           | Roll units (degrees)                                                     |
+--------+-------------+--------------------------------------------------------------------------+
| 8      | ROLL        | Transducer #2 ID (roll)                                                  |
+--------+-------------+--------------------------------------------------------------------------+
| 9      | A           | Transducer type #3 (angular displacement)                                |
+--------+-------------+--------------------------------------------------------------------------+
| 10     | x.x         | Pitch measurement, degrees between -90.0 and 90.0                        |
+--------+-------------+--------------------------------------------------------------------------+
| 11     | D           | Pitch units (degrees)                                                    |
+--------+-------------+--------------------------------------------------------------------------+
| 12     | PITCH       | Transducer #3 ID (pitch)                                                 |
+--------+-------------+--------------------------------------------------------------------------+
| 13     | hh          | Checksum                                                                 |
+--------+-------------+--------------------------------------------------------------------------+
